    ...
    <section class="page-section bg-light text-center">
        <div class="container">
                        ...
                        <div class="col-md-4">
                            <div class="card mb-4">
                                ...
                                <div class="card-footer">
                                    <a href="Borrarbolsa?cursoId=<%=curso.getCodigo()%>&bolsaId=<%=a.getId()%>" class="btn btn-danger">Eliminar</a>
                                </div>
                            </div>
                        </div>
                <% } } else { %>
            ...
            <a href="BolsaCompras.jsp" class="btn btn-success btn-lg">Completar Compra</a>
        </div>
    </section>
