                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card h-100">
                            <div class="card-body">
                                    ...
                                    <a href="CursoMostrar?nombre=<%= curso.getCodigo()%>"> <img class="card-img-top img-fluid" src="data:image/jpeg;base64,<%= base64Image %>" alt="Imagen del Curso" style="height: 200px; object-fit: cover; width: 100%;"></a> 
